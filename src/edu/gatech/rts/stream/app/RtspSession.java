...
import edu.gatech.rts.stream.streaming.Stream;
import edu.gatech.rts.stream.streaming.audio.AMRNBStream;
import edu.gatech.rts.stream.streaming.audio.GenericAudioStream;
import edu.gatech.rts.stream.streaming.video.H264Stream;
import edu.gatech.rts.stream.streaming.video.VideoQuality;
import edu.gatech.rts.stream.streaming.video.VideoStream;

public class RtspSession {

	public final static String TAG = "RtspSession";
	...
	public RtspSession(InetAddress destination, Handler handler) {
